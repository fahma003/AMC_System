...
export default function FullAmcReport() {
    ...
    const handleDownloadPDF = () => {
        ...
        const doc = new jsPDF('landscape', 'pt', 'a3'); // Landscape mode, A3 size
    
        // Add title and metadata
        const comName = "NexaSoft";
        const pageWidth = doc.internal.pageSize.width;
        doc.setTextColor(204, 153, 255);
        doc.text(comName, pageWidth - 14 - doc.getTextWidth(comName), 20);
    
        doc.setTextColor(0, 0, 0);
        doc.text("Full AMC Report", 14, 20);
        ...
        doc.autoTable({
            ...
            styles: {
                ...
                overflow: 'linebreak',    // Allow content to wrap
            },
            headStyles: {
                fillColor: [204, 153, 255],
                textColor: [255, 255, 255]
            },
            columnStyles: {
                0: { cellWidth: 140 },  // Adjust widths as necessary
                1: { cellWidth: 140 },
                2: { cellWidth: 140 },
                3: { cellWidth: 140 },
                4: { cellWidth: 140 },
        ...
        doc.text("Summary:", 14, finalY);
        doc.text(`Total Contracts: ${reportData.totalContracts}`, 14, finalY + 20);
        doc.text(`Total Cost: Rs${reportData.totalCost.toFixed(2)}`, 14, finalY + 40);
