...
function Invoice() {
  ...
  // Fetch both "Bill To" and "Invoice" data from the backend
  useEffect(() => {
    const fetchDetails = async () => {
      try {
        ...
        if (billToResponse.ok) {
          ...
          console.error("Error fetching 'Bill To' details:", billToResponse.statusText);
        }
        ...
        if (invoiceResponse.ok) {
          ...
          setItems(invoiceData.items || items);
          setNotes(invoiceData.notes || "");
          setTerms(invoiceData.termsAndConditions || "");
          ...
          console.error("Error fetching invoice details:", invoiceResponse.statusText);
        }
      } catch (error) {
      ...
      {showPopup && (
        <div className="popup-overlay1">
          <div className="popupInvoice">
            <h2>Invoice Added Successfully!</h2>
